...
router.post('/addVisita', async (req, res) => {
        ...
        const { idVisitador, mailVisitador, mailReceptor, whatsapp, nroDni, 
        tipoDni, nombre, diaHoraDesde, diaHoraHasta } = req.body;
    ...
    try {
        ...
        const visita = new Visita({idVisitador, mailVisitador,  
            whatsapp, nroDni, tipoDni, nombre, diaHoraDesde, 
            diaHoraHasta, estado, mailReceptor});
        await visita.save();

        const Param = new Parametria({idVisitador, mailVisitador,  
            whatsapp, nroDni, tipoDni, nombre, diaHoraDesde, 
            diaHoraHasta, estado, mailReceptor});
        ...
        if (visita.idVisitador) {
            ...
            const imageName = await qrManager.saveQR(data);
